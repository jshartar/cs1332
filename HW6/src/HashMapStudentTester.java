 ...
 * @version 1.0
 */
public class HashMapStudentTester {
    ...
    public void testResize() {
        ...
        MapEntry<String, String>[] copyTable = animals.getTable();
        assertEquals(8, animals.size());
        assertEquals("Jersey", copyTable[8].getKey());
        assertEquals("Dalmation", copyTable[6].getNext().getKey());
        assertEquals("A", copyTable[14].getKey());
        assertEquals("Teacup", copyTable[4].getKey());
        assertEquals("Siamese", copyTable[9].getKey());
        assertEquals("Terrier", copyTable[16].getKey());
        assertEquals("N", copyTable[10].getKey());
        assertEquals("Cheshire", copyTable[6].getKey());
    }
